...
rownames(logCPM) <- y$genes[["ens_gene"]] # this is where wrong ordering of the t2ged/annot table becomes apparent
...
group_names <- group_names[c(1,2,3,4,5)] # reordering to match logCPM order
